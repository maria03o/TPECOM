...
export class element {
	...
	// inserts a child element by index
	// the child element must be an instance of this class
	// the index must be a valid index
	insert_child(index, child) {
		this._elem.insertBefore(child.get_elem(), this._elem.children[index]);
		return this;
	}
	...
	get_child(index) {
		return _to_element(this._elem.children[index]);
	}
...
export function get_body() {
	return new element().elem(document.body);
}
